...
Remove-Module WinEventLogParsing -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\WinEventLogParsing.psd1"
Import-Module "$PSScriptRoot\..\WinEventLogParsing.psm1" -Force
