<#
    .SYNOPSIS
        Installs the WinEventLogParsing Module from github

    .DESCRIPTION
        This script installs the WinEventLogParsing Module from github.
...
$ModuleName = "WinEventLogParsing"

# Base path to the github repository
$BaseUrl = "https://github.com/AndiBellstedt/$($ModuleName)"
